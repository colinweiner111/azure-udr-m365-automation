...
def main(mytimer: func.TimerRequest) -> None:
    ...
    Runs daily (configurable in function.json).
    ...
    logger.info(f"Timer trigger: {mytimer.scheduled_utc if mytimer else 'manual'}")
...
def log_summary(
    ...
    Args:
        ...
        total_cidrs: Total number of CIDRs.
        to_add: CIDRs to add.
        to_remove: CIDRs to remove.
        add_summary: Route addition summary.
        remove_summary: Route removal summary.
    """
    logger.info("=" * 80)
